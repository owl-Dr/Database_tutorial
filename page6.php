    ...
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-heading">
                ...
                <button type="button" class="btn btn-sm btn-danger" onclick="addThesis()">Add Details</button>
            </div>
    ...
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-heading">
                ...
                <button type="button" class="btn btn-sm btn-danger" onclick="addMastersThesis()">Add Details</button>
            </div>
            <div class="panel-body">
            <table class="table table-bordered">
                    <thead>
      ...
      <div class="row">
          <div class="col-md-12">
            ...
            <div class="panel-heading">
                ...
                <button type="button" class="btn btn-danger" onclick="addBachelorDegree()">Add Details</button>
            </div>
                <div class="panel-body">
                <table class="table table-bordered">
                        <thead>
