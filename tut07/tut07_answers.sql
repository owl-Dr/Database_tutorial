...
BEGIN
    SELECT em.*, dept.department_name, dept.location
    FROM employees em
...
BEGIN
    SELECT dept.department_name, COUNT(em.emp_id) AS total_employees
    FROM departments dept
    LEFT JOIN employees em ON dept.department_id = em.department_id
