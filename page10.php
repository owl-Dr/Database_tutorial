...
<body>
    <div class="container clearfix">
        ...
        <h1 style="margin-bottom: 20px;">Faculty Application Form IIT Patna</h1> <!-- Added space after the heading -->
        
        <!-- Personal Details -->
        <h2 style="margin-bottom: 10px;">Personal Details</h2> <!-- Added space after the heading -->
        <table class="table">
            <tr>
                <th>Name</th>
...
<h2 style="margin-top: 20px; margin-bottom: 10px;">Significant research contribution and future plans</h2>
<?php
...
<h2 style="margin-top: 20px; margin-bottom: 10px;">Significant teaching contribution and future plans</h2>
<?php
...
<h2 style="margin-top: 20px; margin-bottom: 10px;">Any other relevant information</h2>
<?php
...
<h2 style="margin-top: 20px; margin-bottom: 10px;">Professional Service as Reviewer/Editor etc.</h2>
<?php
...
<h2 style="margin-top: 20px; margin-bottom: 10px;">Detailed List of Journal Publications</h2>
<?php
...
<h2 style="margin-top: 20px; margin-bottom: 10px;"> Detailed List of Conference Publications</h2>
<?php
...
<!-- Final Declaration -->
<h2 style="margin-top: 20px; margin-bottom: 10px;">Final Declaration</h2>
<p>
