			...
			<div class="col-xs-12 col-sm-12 col-md-12 well">
				<form class="form-horizontal" action="page2insert.php" method="post" enctype="multipart/form-data">
					...
					<legend>
                            <div class="row">
                                <div class="col-md-10">
                                    <h4>Welcome : <font color="#025198"><?php echo $loggedInUserName; ?></font></h4>
                                </div>
                                <div class="col-md-2">
								...
								<div class="col-md-12">
										<div class="panel panel-success">
												...
												<div class="panel-body">
														...
														<div class="col-md-4">
																<input id="college_phd" value="<?php echo isset($_SESSION['Phd_Thesis']['University_Institute']) ? $_SESSION['Phd_Thesis']['University_Institute'] : ''; ?>" name="college_phd" type="text" placeholder="University/Institute" class="form-control input-md" autofocus="" required="">
														</div>

														<span class="col-md-2 control-label" for="stream">Department</span>
														<div class="col-md-4">
																<input id="stream" value="<?php echo isset($_SESSION['Phd_Thesis']['Department']) ? $_SESSION['Phd_Thesis']['Department'] : ''; ?>" name="stream" type="text" placeholder="Department" class="form-control input-md" autofocus="">
														</div>

														<span class="col-md-2 control-label" for="supervisor">Name of PhD Supervisor</span>
														<div class="col-md-4">
																<input id="supervisor" name="supervisor" type="text" placeholder="Name of Ph. D. Supervisor" value="<?php echo isset($_SESSION['Phd_Thesis']['Supervisor_Name']) ? $_SESSION['Phd_Thesis']['Supervisor_Name'] : ''; ?>" class="form-control input-md" required="">
														</div>

														<span class="col-md-2 control-label" for="yoj_phd">Year of Joining</span>
														<div class="col-md-4">
																<input id="yoj_phd" value="<?php echo isset($_SESSION['Phd_Thesis']['Year_of_Joining']) ? $_SESSION['Phd_Thesis']['Year_of_Joining'] : ''; ?>" name="yoj_phd" type="text" placeholder="Year of Joining" class="form-control input-md" required="">
														</div>
														...
														<div class="row">
																<div class="col-md-12">
																		...
																		<div class="col-md-4">
																				<input id="dod_phd" name="dod_phd" type="date" value="<?php echo isset($_SESSION['Phd_Thesis']['Successful_Thesis_Date']) ? $_SESSION['Phd_Thesis']['Successful_Thesis_Date'] : ''; ?>" class="form-control input-md datepicker" required="">
																		</div>

																		<span class="col-md-2 control-label" for="doa_phd">Date of Award</span>
																		<div class="col-md-4">
																				<input id="doa_phd" name="doa_phd" type="date" value="<?php echo isset($_SESSION['Phd_Thesis']['Award_Date']) ? $_SESSION['Phd_Thesis']['Award_Date'] : ''; ?>" class="form-control input-md datepicker" required="">
																		</div>
																</div>
														</div>
														<br />
														...
														<div class="col-md-10">
																<input id="phd_title" value="<?php echo isset($_SESSION['Phd_Thesis']['Thesis_Title']) ? $_SESSION['Phd_Thesis']['Thesis_Title'] : ''; ?>" name="phd_title" type="text" placeholder="Title of PhD Thesis" class="form-control input-md" required="">
														</div>
								...
								<div class="col-md-12">
										<div class="panel panel-success">
												...
												<div class="panel-body">
														...
														<div class="col-md-4">
																<input id="pg_degree" value="<?php echo isset($_SESSION['MTech']['Degree_Certificate']) ? $_SESSION['MTech']['Degree_Certificate'] : ''; ?>" name="pg_degree" type="text" placeholder="Degree/Certificate" class="form-control input-md" autofocus="">
														</div>

														<span class="col-md-2 control-label" for="pg_college">University/Institute</span>
														<div class="col-md-4">
																<input id="pg_college" value="<?php echo isset($_SESSION['MTech']['University_Institute']) ? $_SESSION['MTech']['University_Institute'] : ''; ?>" name="pg_college" type="text" placeholder="University/Institute" class="form-control input-md" autofocus="">
														</div>

														<span class="col-md-2 control-label" for="pg_subjects">Branch/Stream</span>
														<div class="col-md-4">
																<input id="pg_subjects" name="pg_subjects" type="text" placeholder="Branch/Stream" value="<?php echo isset($_SESSION['MTech']['Branch_Stream']) ? $_SESSION['MTech']['Branch_Stream'] : ''; ?>" class="form-control input-md">
														</div>

														<span class="col-md-2 control-label" for="pg_yoj">Year of Joining</span>
														<div class="col-md-4">
																<input id="pg_yoj" value="<?php echo isset($_SESSION['MTech']['Year_of_Joining']) ? $_SESSION['MTech']['Year_of_Joining'] : ''; ?>" name="pg_yoj" type="text" placeholder="Year of Joining" class="form-control input-md">
														</div>
														...
														<div class="row">
																<div class="col-md-12">
																		...
																		<div class="col-md-4">
																				<input id="pg_yog" name="pg_yog" type="text" placeholder="Year of Completion" value="<?php echo isset($_SESSION['MTech']['Year_of_Completion']) ? $_SESSION['MTech']['Year_of_Completion'] : ''; ?>" class="form-control input-md">
																		</div>

																		<span class="col-md-2 control-label" for="pg_duration">Duration (in years)</span>
																		<div class="col-md-4">
																				<input id="pg_duration" name="pg_duration" type="text" placeholder="Duration" value="<?php echo isset($_SESSION['MTech']['Duration_Years']) ? $_SESSION['MTech']['Duration_Years'] : ''; ?>" class="form-control input-md">
																		</div>

																		<span class="col-md-2 control-label" for="pg_perce">Percentage/CGPA</span>
																		<div class="col-md-4">
																				<input id="pg_perce" name="pg_perce" type="text" placeholder="Percentage/CGPA" value="<?php echo isset($_SESSION['MTech']['Percentage_CGPA']) ? $_SESSION['MTech']['Percentage_CGPA'] : ''; ?>" class="form-control input-md">
																		</div>

																		<span class="col-md-2 control-label" for="pg_rank">Division/Class</span>
																		<div class="col-md-4">
																				<input id="pg_rank" name="pg_rank" type="text" placeholder="Division/Class" value="<?php echo isset($_SESSION['MTech']['Division_Class']) ? $_SESSION['MTech']['Division_Class'] : ''; ?>" class="form-control input-md">
																		</div>
								...
								<div class="col-md-12">
										<div class="panel panel-success">
												...
												<div class="panel-body">
														...
														<div class="col-md-4">
																<input id="ug_degree" value="<?php echo isset($_SESSION['BTech']['Degree_Certificate']) ? $_SESSION['BTech']['Degree_Certificate'] : ''; ?>" name="ug_degree" type="text" placeholder="Degree/Certificate" class="form-control input-md" autofocus="" required="">
														</div>

														<span class="col-md-2 control-label" for="ug_college">University/Institute</span>
														<div class="col-md-4">
																<input id="ug_college" value="<?php echo isset($_SESSION['BTech']['University_Institute']) ? $_SESSION['BTech']['University_Institute'] : ''; ?>" name="ug_college" type="text" placeholder="University/Institute" class="form-control input-md" autofocus="">
														</div>

														<span class="col-md-2 control-label" for="ug_subjects">Branch/Stream</span>
														<div class="col-md-4">
																<input id="ug_subjects" name="ug_subjects" type="text" placeholder="Branch/Stream" value="<?php echo isset($_SESSION['BTech']['Branch_Stream']) ? $_SESSION['BTech']['Branch_Stream'] : ''; ?>" class="form-control input-md" required="">
														</div>

														<span class="col-md-2 control-label" for="ug_yoj">Year of Joining</span>
														<div class="col-md-4">
																<input id="ug_yoj" value="<?php echo isset($_SESSION['BTech']['Year_of_Joining']) ? $_SESSION['BTech']['Year_of_Joining'] : ''; ?>" name="ug_yoj" type="text" placeholder="Year of Joining" class="form-control input-md" required="">
														</div>
														...
														<div class="row">
																<div class="col-md-12">
																		...
																		<div class="col-md-4">
																				<input id="ug_yog" name="ug_yog" type="text" placeholder="Year of Completion" value="<?php echo isset($_SESSION['BTech']['Year_of_Completion']) ? $_SESSION['BTech']['Year_of_Completion'] : ''; ?>" class="form-control input-md" required="">
																		</div>

																		<span class="col-md-2 control-label" for="ug_duration">Duration (in years)</span>
																		<div class="col-md-4">
																				<input id="ug_duration" name="ug_duration" type="text" placeholder="Duration" value="<?php echo isset($_SESSION['BTech']['Duration_Years']) ? $_SESSION['BTech']['Duration_Years'] : ''; ?>" class="form-control input-md" required="">
																		</div>

																		<span class="col-md-2 control-label" for="ug_perce">Percentage/CGPA</span>
																		<div class="col-md-4">
																				<input id="ug_perce" name="ug_perce" type="text" placeholder="Percentage/ CGPA" value="<?php echo isset($_SESSION['BTech']['Percentage_CGPA']) ? $_SESSION['BTech']['Percentage_CGPA'] : ''; ?>" class="form-control input-md" required="">
																		</div>

																		<span class="col-md-2 control-label" for="ug_rank">Division/Class</span>
																		<div class="col-md-4">
																				<input id="ug_rank" name="ug_rank" type="text" placeholder="Division/Class" value="<?php echo isset($_SESSION['BTech']['Division_Class']) ? $_SESSION['BTech']['Division_Class'] : ''; ?>" class="form-control input-md" required="">
																		</div>
																</div>
														</div>
														<br />
				...
				?>
																<tr height="60px">
																		<td class="col-md-2">
																				<input id="add_degree1" name="add_degree[]" type="text" value="<?= htmlspecialchars($record['Degree_Certificate']) ?>" placeholder="Degree" class="form-control input-md" maxlength="10" required="">
																		</td>
																		<td class="col-md-2">
																				<input id="add_college1" name="add_college[]" type="text" value="<?= htmlspecialchars($record['University_Institute']) ?>" placeholder="College" class="form-control input-md" maxlength="80" required="">
																		</td>
																		<td class="col-md-2">
																				<input id="add_subjects1" name="add_subjects[]" type="text" value="<?= htmlspecialchars($record['Branch_Stream']) ?>" placeholder="Subjects" class="form-control input-md" maxlength="80" required="">
																		</td>
																		<td class="col-md-2">
																				<input id="add_yoj1" name="add_yoj[]" type="text" value="<?= htmlspecialchars($record['Year_of_Joining']) ?>" placeholder="Year of Joining" class="form-control input-md" maxlength="5" required="">
																		</td>
																		<td class="col-md-2">
																				<input id="add_yog1" name="add_yog[]" type="text" value="<?= htmlspecialchars($record['Year_of_Completion']) ?>" placeholder="Year of Graduation" class="form-control input-md" maxlength="5" required="">
																		</td>
																		<td class="col-md-2">
																				<input id="add_duration1" name="add_duration[]" type="text" value="<?= htmlspecialchars($record['Duration_Years']) ?>" placeholder="Duration" class="form-control input-md" maxlength="4" required="">
																		</td>
																		<td class="col-md-2">
																				<input id="add_perce1" name="add_perce[]" type="text" value="<?= htmlspecialchars($record['Percentage_CGPA']) ?>" placeholder="Percentage" class="form-control input-md" maxlength="5" required="">
																		</td>
																		<td class="col-md-2">
																				<input id="add_rank1" name="add_rank[]" type="text" value="<?= htmlspecialchars($record['Division_Class']) ?>" placeholder="Percentage" class="form-control input-md" maxlength="5" required="">
																		</td>
																</tr>
												<?php
														} // End of foreach loop
