...
<style type="text/css">
	body { background-color: aliceblue; padding-top:0px!important;}
...
<div class="container" style="border-radius:10px; height:300px; margin-top:20px;">
    ...
    <div class="row" style="border-width: 2px; border-style: solid; border-radius: 10px; box-shadow: 0px 1px 30px 1px #284d7a; background-color:#F7FFFF;">
         ...
         <div class="col-md-6"style=" height:403px; border-radius: 10px 0px 0px 10px;"><img src="iitplogo.png" style="margin-top: 5%; margin-left: 20%; height: 75%">
        ...
        <div class="col-md-6" style="border-radius: 0px 10px 10px 0px; height: 403px;">
         <br />
          <div class="col-md-10 col-md-offset-1">
           <h3 style="text-align: center; color: black; font-weight: 800;"><strong><u>LOGIN HERE</u></strong></h3><br />
           ...
           <form role="form" method="post">
            <input type="hidden" name="ci_csrf_token" value="" />
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-9">
                      <a href="forgot.php"><button type="button" class="cancelbtn pull-right">Reset Password</button></a>
                    </div>
                  </div>
