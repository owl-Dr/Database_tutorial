        ...
        <div class="container">
            <div class="row" style="margin-bottom:10px; ">
                <div class="col-md-8 col-md-offset-2">
                    <h3 style="text-align:center;color:aliceblue!important;font-weight: bold;font-size: 2.3em; margin-top: 3px; font-family: 'Noto Sans', sans-serif;">भारतीय प्रौद्योगिकी संस्थान पटना</h3>
                    <h3 style="text-align:center;color:aliceblue!important;font-weight: bold;font-family: 'Oswald', sans-serif!important;font-size: 2.2em; margin-top: 0px;">Indian Institute of Technology Patna</h3>
                </div>
            </div>
        </div>
    </div>
                ...
                <form class="form-horizontal" action="page1insert.php" method="post" enctype="multipart/form-data">
                    <fieldset>
                        <legend>
                            <div class="row">
                                <div class="col-md-11">
                                    <h4>Welcome : <font color="#025198"><strong><?php echo isset($loggedInUserName) ? $loggedInUserName : ''; ?></strong></font></h4>
                                </div>
                                <div class="col-md-1">
                            ...
                            <div class="panel-body">
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input id="fname" name="fname" type="text" placeholder="First name" class="form-control input-md" maxlength="15" required value="<?php echo isset($_SESSION['PersonalDetails']['First_Name']) ? $_SESSION['PersonalDetails']['First_Name'] : ''; ?>">
                                        </div>
                                        <!-- Middle Name -->
                                        <span class="col-md-2 control-label" for="mname">Middle Name</span>
                                        <div class="col-md-4">
                                            <input id="mname" name="mname" type="text" placeholder="Middle name" class="form-control input-md" maxlength="12" value="<?php echo isset($_SESSION['PersonalDetails']['Middle_Name']) ? $_SESSION['PersonalDetails']['Middle_Name'] : ''; ?>">
                                        </div>
                                        <!-- Last Name -->
                                        <span class="col-md-2 control-label" for="lname">Last Name*</span>
                                        <div class="col-md-4">
                                            <input id="lname" name="lname" type="text" placeholder="Last name" class="form-control input-md" maxlength="15" required value="<?php echo isset($_SESSION['PersonalDetails']['Last_Name']) ? $_SESSION['PersonalDetails']['Last_Name'] : ''; ?>">
                                        </div>
                                        <!-- Nationality -->
                                        ...
                                        <div class="col-md-4">
                                            <input id="dob" name="dob" type="date" class="form-control input-md" required  value="<?php echo isset($_SESSION['PersonalDetails']['Date_of_Birth']) ? $_SESSION['PersonalDetails']['Date_of_Birth'] : ''; ?>">
                                        </div>
                                        <!-- Gender -->
                                        ...
                                        <div class="col-md-4">
                                            <input id="cast" name="cast" type="text" placeholder="cast" readonly value="<?php echo isset($_SESSION['users']['cast']) ? $_SESSION['users']['cast'] : ''; ?>" class="form-control input-md" required>
                                        </div>
                                        <!-- ID Proof -->
                                        ...
                                        <div class="col-md-4">
                                            <input id="father_name" name="father_name" type="text" placeholder="Father's Name" class="form-control input-md" maxlength="30" required value="<?php echo isset($_SESSION['PersonalDetails']['Father_Name']) ? $_SESSION['PersonalDetails']['Father_Name'] : ''; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2 pull-right">
                                    <img src="<?php echo isset($_SESSION['Photo']['photo']) ? $_SESSION['Photo']['photo'] : '' ?>" class="thumbnail pull-right" height="150" width="130" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <br>
                                            ...
                                            <textarea style="height:40px" placeholder="Street" class="form-control input-md" name="cadd" maxlength="200" required><?php echo isset($caddress_parts[0]) ? $caddress_parts[0] : ''; ?></textarea>
                                            <textarea style="height:40px" placeholder="City" class="form-control input-md" name="cadd1" maxlength="200" required><?php echo isset($caddress_parts[1]) ? $caddress_parts[1] : ''; ?></textarea>
                                            <textarea style="height:40px" placeholder="State" class="form-control input-md" name="cadd2" maxlength="200" required><?php echo isset($caddress_parts[2]) ? $caddress_parts[2] : ''; ?></textarea>
                                            <textarea style="height:40px" placeholder="Country" class="form-control input-md" name="cadd3" maxlength="200" required><?php echo isset($caddress_parts[3]) ? $caddress_parts[3] : ''; ?></textarea>
                                            <textarea style="height:40px" placeholder="PIN/ZIP" class="form-control input-md" name="cadd4" maxlength="200" required><?php echo isset($caddress_parts[4]) ? $caddress_parts[4] : ''; ?></textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <span class="col-md-6 control-label" for="padd">Permanent Address *</span>
																						<br>
																						<br>
                                            <textarea style="height:40px" placeholder="Street" class="form-control input-md" name="padd" maxlength="200" required><?php echo isset($paddress_parts[0]) ? $paddress_parts[0] : ''; ?></textarea>
                                            <textarea style="height:40px" placeholder="City" class="form-control input-md" name="padd1" maxlength="200" required><?php echo isset($paddress_parts[1]) ? $paddress_parts[1] : ''; ?></textarea>
                                            <textarea style="height:40px" placeholder="State" class="form-control input-md" name="padd2" maxlength="200" required><?php echo isset($paddress_parts[2]) ? $paddress_parts[2] : ''; ?></textarea>
                                            <textarea style="height:40px" placeholder="Country" class="form-control input-md" name="padd3" maxlength="200" required><?php echo isset($paddress_parts[3]) ? $paddress_parts[3] : ''; ?></textarea>
                                            <textarea style="height:40px" placeholder="PIN/ZIP" class="form-control input-md" name="padd4" maxlength="200" required><?php echo isset($paddress_parts[4]) ? $paddress_parts[4] : ''; ?></textarea>
			</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-success">
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input id="mobile" name="mobile" type="text" placeholder="Mobile" class="form-control input-md" required maxlength="20" value="<?php echo isset($_SESSION['PersonalDetails']['Mobile']) ? $_SESSION['PersonalDetails']['Mobile'] : ''; ?>">
                                    </div>
                                    <!-- Email -->
                                    <span class="col-md-2 control-label" for="email">Email</span>
                                    <div class="col-md-4">
                                        <input id="email" name="email" type="email" placeholder="Email" class="form-control input-md" value="<?php echo isset($loggedInEmail) ? $loggedInEmail : ''; ?>" readonly>
                                    </div>
                                    <!-- Alternate Mobile -->
                                    <span class="col-md-2 control-label" for="mobile_2">Alternate Mobile</span>
                                    <div class="col-md-4">
                                        <input id="mobile_2" name="mobile_2" type="text" placeholder="Alternate Mobile" class="form-control input-md" maxlength="20" value="<?php echo isset($_SESSION['PersonalDetails']['Alternate_Mobile']) ? $_SESSION['PersonalDetails']['Alternate_Mobile'] : ''; ?>">
                                    </div>
                                    <!-- Alternate Email -->
                                    <span class="col-md-2 control-label" for="email_2">Alternate Email</span>
                                    <div class="col-md-4">
                                        <input id="email_2" name="email_2" type="email" placeholder="Alternate Email" class="form-control input-md" value="<?php echo isset($_SESSION['PersonalDetails']['Alternate_Email']) ? $_SESSION['PersonalDetails']['Alternate_Email'] : ''; ?>">
                                    </div>
                                    <!-- Landline Number -->
                                    <span class="col-md-2 control-label" for="landline">Landline Number</span>
                                    <div class="col-md-4">
                                        <input id="landline" name="landline" type="text" placeholder="Landline Number" class="form-control input-md" maxlength="20" value="<?php echo isset($_SESSION['PersonalDetails']['Landline_Number']) ? $_SESSION['PersonalDetails']['Landline_Number'] : ''; ?>">
                                    </div>
