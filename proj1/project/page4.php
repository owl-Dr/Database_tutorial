...
<div class="container" style="border-radius: 4px; box-shadow: 0 0 15px rgba(0, 0, 0, 0.6);">
    ...
    <div class="row">
                ...
                <div class="col-md-12">
                    <div class="panel panel-success">
                        <div class="panel-body">
                            ...
                            <div class="col-md-1">
                                <input id="summary_journal_inter" name="summary_journal_inter" type="text" placeholder="" class="form-control input-md" required="" maxlength="3" value="<?php echo isset($_SESSION['Publications']['summary_journal_inter']) ? $_SESSION['Publications']['summary_journal_inter'] : ''; ?>">
                            </div>

                            <span class="col-md-5 control-label" for="summary_journal">Number of National Journal Papers</span>  
                            <div class="col-md-1">
                                <input id="summary_journal" name="summary_journal" type="text" placeholder="" class="form-control input-md" required="" maxlength="3" value="<?php echo isset($_SESSION['Publications']['summary_journal']) ? $_SESSION['Publications']['summary_journal'] : ''; ?>">
                            </div>

                            <span class="col-md-5 control-label" for="summary_conf_inter">Number of International Conference Papers</span>  
                            <div class="col-md-1">
                                <input id="summary_conf_inter" name="summary_conf_inter" type="text" placeholder="" class="form-control input-md" required="" maxlength="3" value="<?php echo isset($_SESSION['Publications']['summary_conf_inter']) ? $_SESSION['Publications']['summary_conf_inter'] : ''; ?>">
                            </div>

                            <span class="col-md-5 control-label" for="summary_conf_national">Number of National Conference Papers</span>  
                            <div class="col-md-1">
                                <input id="summary_conf_national" name="summary_conf_national" type="text" placeholder="" class="form-control input-md" required="" maxlength="3" value="<?php echo isset($_SESSION['Publications']['summary_conf_national']) ? $_SESSION['Publications']['summary_conf_national'] : ''; ?>">
                            </div>

                            <span class="col-md-5 control-label" for="patent_publish">Number of Patent(s) [Filed, Published, Granted] </span>  
                            <div class="col-md-1">
                                <input id="patent_publish" name="patent_publish" type="text" placeholder="" class="form-control input-md" required="" maxlength="3" value="<?php echo isset($_SESSION['Publications']['patent_publish']) ? $_SESSION['Publications']['patent_publish'] : ''; ?>">
                            </div>

                            <span class="col-md-5 control-label" for="summary_book">Number of Book(s) </span>  
                            <div class="col-md-1">
                                <input id="summary_book" name="summary_book" type="text" placeholder="" class="form-control input-md" required="" maxlength="3" value="<?php echo isset($_SESSION['Publications']['summary_book']) ? $_SESSION['Publications']['summary_book'] : ''; ?>">
                            </div>

                            <span class="col-md-5 control-label" for="summary_book_chapter">Number of Book Chapter(s)</span>  
                            <div class="col-md-1">
                                <input id="summary_book_chapter" name="summary_book_chapter" type="text" placeholder="" class="form-control input-md" required="" maxlength="3" value="<?php echo isset($_SESSION['Publications']['summary_book_chapter']) ? $_SESSION['Publications']['summary_book_chapter'] : ''; ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <h4 style="text-align:center; font-weight: bold; color: #6739bb;">6. List of 10 Best Publications (Journal/Conference)</h4>
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <button type="button" class="btn btn-sm btn-danger" onclick="addPublication()">Add Details</button>
                        </div>
                        <div class="panel-body">
            ...
            <h4 style="text-align:center; font-weight: bold; color: #6739bb;">7. List of  Patent(s), Book(s), Book Chapter(s)</h4>
                <div class="panel panel-success">
                    <div class="panel-heading">(A) Patent(s)
                        <button type="button" class="btn btn-sm btn-danger" onclick="addPatent()">Add Details</button>
                    </div>
                    <div class="panel-body">
                        <table class="table table-bordered">
                ...
                <!-- <div class="col-md-12"> -->
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">(B) Book(s)
                            <button type="button" class="btn btn-sm btn-danger" onclick="addBook()">Add Details</button>
                        </div>
                        <div class="panel-body">
                            <table class="table table-bordered">
        ...
        <div class="row">
            <!-- <div class="col-md-12"> -->
                <h4 style="text-align:center; font-weight: bold; color: #6739bb;">(C) Book Chapter(s)</h4>
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <button type="button" class="btn btn-sm btn-danger" onclick="addBookChapter()">Add Details</button>
                    </div>
                    <div class="panel-body">
                        <table class="table table-bordered">
        ...
        <div class="col-md-12">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-10">
                        <input id="google_link" value="<?php echo isset($_SESSION['Scholar']['scholar']) ? $_SESSION['Scholar']['scholar'] : ''; ?>" name="google_link" type="text" placeholder="Google Scholar Link" class="form-control input-md" required="">
                    </div>
                </div>
            </div>
        </div>
