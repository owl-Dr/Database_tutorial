    ...
    <div class="col-md-12">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-4">
                    <input id="pres_emp_position" name="pres_emp_position" type="text" placeholder="Position" class="form-control input-md" autofocus="" required="" value="<?php echo isset($_SESSION['Employment_Details']['Position']) ? $_SESSION['Employment_Details']['Position'] : ''; ?>">
                </div>

                <span class="col-md-2 control-label" for="pres_emp_employer">Organization/Institution</span>  
                <div class="col-md-4">
                    <input id="pres_emp_employer" name="pres_emp_employer" type="text" placeholder="Organization/Institution" class="form-control input-md" autofocus="" value="<?php echo isset($_SESSION['Employment_Details']['Organization_Institution']) ? $_SESSION['Employment_Details']['Organization_Institution'] : ''; ?>">
                </div> 
                ...
                <div class="col-md-4">
                    <select id="pres_status" name="pres_status" class="form-control input-md" required="">
                        ...
                        <option <?php echo isset($_SESSION['Employment_Details']['Status']) && $_SESSION['Employment_Details']['Status'] === 'Central Govt.' ? 'selected' : ''; ?> value="Central Govt.">Central Govt.</option>
                        <option <?php echo isset($_SESSION['Employment_Details']['Status']) && $_SESSION['Employment_Details']['Status'] === 'State Government' ? 'selected' : ''; ?> value="State Government">State Government</option>
                        <option <?php echo isset($_SESSION['Employment_Details']['Status']) && $_SESSION['Employment_Details']['Status'] === 'Private' ? 'selected' : ''; ?> value="Private">Private</option>
                        <option <?php echo isset($_SESSION['Employment_Details']['Status']) && $_SESSION['Employment_Details']['Status'] === 'Quasi Govt.' ? 'selected' : ''; ?> value="Quasi Govt.">Quasi Govt.</option>
                        <option <?php echo isset($_SESSION['Employment_Details']['Status']) && $_SESSION['Employment_Details']['Status'] === 'Other' ? 'selected' : ''; ?> value="Other">Other</option>
                    </select>
                </div>

                <span class="col-md-2 control-label" for="pres_emp_doj">Date of Joining</span>  
                <div class="col-md-4">
                    <input id="pres_emp_doj" name="pres_emp_doj" type="date" placeholder="Date of Joining" class="form-control input-md" required="" value="<?php echo isset($_SESSION['Employment_Details']['Date_of_Joining']) ? $_SESSION['Employment_Details']['Date_of_Joining'] : ''; ?>">
                </div>

                <span class="col-md-2 control-label" for="pres_emp_dol">Date of Leaving <br />(Mention Continue if working)</span>  
                <div class="col-md-4">
                    <input id="pres_emp_dol" name="pres_emp_dol" type="date" placeholder="Date of Leaving" class="form-control input-md" required="" value="<?php echo isset($_SESSION['Employment_Details']['Date_of_Leaving']) ? $_SESSION['Employment_Details']['Date_of_Leaving'] : ''; ?>">
                </div>
              
                <span class="col-md-2 control-label" for="pres_emp_duration">Duration (in years & months)</span>  
                <div class="col-md-4">
                    <input id="pres_emp_duration" name="pres_emp_duration" type="text" placeholder="Duration" class="form-control input-md" required="" value="<?php echo isset($_SESSION['Employment_Details']['Duration']) ? $_SESSION['Employment_Details']['Duration'] : ''; ?>">
                </div>
            </div>
        </div>
      </div>
...
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-success">
      ...
      <button type="button" class="btn btn-sm btn-danger" id="add_more_exp" onclick="addEmploymentDetails()">Add Details</button>
      </div>
      <div class="panel-body">
    ...
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-heading">(C) Teaching Experience (After PhD)
              <button type="button" class="btn btn-sm btn-danger" onclick="addTeachingExperience()">Add Details</button>
            </div>
            <div class="panel-body">
                <table class="table table-bordered">
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            ...
            <button type="button" class="btn btn-sm btn-danger" onclick="addIndustrialExperience()">Add Details</button>
            </div>
            <div class="panel-body">
                <table class="table table-bordered">
  ...
  <div class="col-md-6">
      <div class="panel panel-success">
          ...
          <div class="panel-body">
              ...
              <textarea style="height:150px" placeholder="Areas of specialization" class="form-control input-md" name="area_spl" maxlength="500" required=""><?php echo isset($_SESSION['Areas']['specialization']) ? $_SESSION['Areas']['specialization'] : ''; ?></textarea>
          </div>
      </div>
  </div>
  ...
  <div class="col-md-6">
    <div class="panel panel-success">
      ...
      <div class="panel-body">
        ...
        <textarea style="height:150px" placeholder="Areas of research" class="form-control input-md" name="area_rese" maxlength="500" required=""><?php echo isset($_SESSION['Areas']['research_area']) ? $_SESSION['Areas']['research_area'] : ''; ?></textarea>
      </div>
    </div>
  </div>
 </div>
...
<div class="form-group">
  ...
  <div class="col-md-1">
    <a href="page2.php" class="btn btn-primary pull-left"><i class="glyphicon glyphicon-fast-backward"></i></a>
  </div>
