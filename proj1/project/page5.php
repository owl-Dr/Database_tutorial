    ...
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-heading">
                Fill the Details &nbsp; &nbsp;
                <button type="button" class="btn btn-sm btn-danger" onclick="addSociety()">Add Row</button>
            </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                Fill the Details &nbsp; &nbsp;
                <button type="button" class="btn btn-sm btn-danger" onclick="addTraining()">Add Row</button>
            </div>
            <div class="panel-body">
                <table class="table table-bordered">
                    <thead>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-heading">
                Fill the Details &nbsp; &nbsp;
                <button type="button" class="btn btn-sm btn-danger" onclick="addAward()">Add Details</button>
            </div>
            <div class="panel-body">
                <table class="table table-bordered">
                    <thead>
    ...
    <!-- <div class="col-md-12"> -->
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                ...
                <button type="button" class="btn btn-sm btn-danger" onclick="addSponsoredProject()">Add Details</button>
            </div>
            <div class="panel-body">
                <table class="table table-bordered">
                    <thead>
    ...
    <!-- <div class="col-md-12"> -->
        <div class="panel panel-success">
            <div class="panel-heading">
                ...
                <button type="button" class="btn btn-sm btn-danger" onclick="addConsultancyProject()">Add Details</button>
            </div>
            <div class="panel-body">
                <table class="table table-bordered">
                    <thead>
