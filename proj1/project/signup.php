    ...
    <div class="container" style=" border-radius:10px; margin-top:20px;">
        <div class="row"
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                <div style="background-image: url(iitplogo.png); height: 400px; background-size: cover; width: 400px; margin: 30px; padding: auto;"></div>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-6">
                <h3>CREATE YOUR PROFILE</h3><br />
<!-- form -->
                <form id="myForm" action="#" method="post" class="form" role="form" onsubmit="return validatePasswordMatch() && validateCaptcha()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input class="form-control" name="cpassword" placeholder="Retype - password"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-6" >
                            <input id="captchaTextBox" class="form-control" name="captcha" placeholder="Insert image text" required=""
                                type="text" />
                        </div>
                        ...
                        <div class="col-xs-12 col-md-12">
                            ...
                            <strong class=" pull-right" style="color: green;">If registered <a
                                    href='index.php'
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    The email address you entered is already associated with an account. Please use a different email address or try logging in.
                </div>
